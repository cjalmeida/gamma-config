...
::
    ...
    pip install git+ssh://git@git.sourceai.io/devex-br/gamma-config.git@v0.1.1

Or, when adding to ``requirements.txt``

::

    gamma-config @ git+ssh://git@git.sourceai.io/devex-br/gamma-config.git@v0.1.1#egg=gamma-config
